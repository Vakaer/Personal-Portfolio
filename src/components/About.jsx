...
import computer from "../assets/lottie/laptop.json";
        ...
        <div className="WRAPPER mt-12 flex justify-between max-sm:flex-col gap-5">
          <div className="INTRO text-[70px] leading-[80px] font-semibold max-sm:text-[50px] max-sm:leading-[70px] max-sm:font-semibold">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r  from-blue-600 to-cyan-600 dark:from-cyan-500 dark:to-slate-200">
              <Typewriter delay={100} text={"Waqar Mujeeb"}/>
            </span>
            ...
            <Typewriter delay={50} text={"Programming enthusiast who often thinks about developing new things for solving real world problems."}/>
            </p>
          </div>
